                ...
                <div class="carlist">
                    ...
                    <div class="main">
                        <ul class="car">
                        	<%
                        		...
                        		ArrayList<Car> list = carDAO.getEasy_Search1(request.getParameter("manufac"), request.getParameter("model"),request.getParameter("detail"));
                        		if (list.size() == 0){
                    ...
                    <div class="pageBtn">
                    	<ul class="pageBtn_ul">
	                    	<% if(pageNumber != 1){ %>
	                    	<li>
	                    		<a class="pageBtn_move" href="CarsEasySearch1.jsp?pageNumber=<%=pageNumber - 1 %>" >이전 페이지</a>
	                    	</li>
							<% } else {%>	
	                    	<li>
	                    	...
	                    	<% } %>
	                    	<li>
	                    		<a class="pageBtn_now" href="CarsEasySearch1.jsp?pageNumber=<%=pageNumber %>"><%=pageNumber %></a>
	                    	</li>
	                    	<% if(carDAO.nextPage(pageNumber + 1)){ %>
	                    	<li>
	                    		<a class="pageBtn_move" href="CarsEasySearch1.jsp?pageNumber=<%=pageNumber + 1 %>">다음 페이지</a>	
	                    	</li>
	                    	<% } else {%>
	                    	<li>
