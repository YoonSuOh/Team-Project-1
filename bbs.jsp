	...
	<div class="container">
		<div class="row">
			<table class="table table-striped"
				...
				<thead>
					<tr>
						<th style="background-color: skyblue; text-align: center;">번호</th>
						<th style="background-color: skyblue; text-align: center;">제목</th>
						<th style="background-color: skyblue; text-align: center;">작성자</th>
						<th style="background-color: skyblue; text-align: center;">작성일</th>
					</tr>
				</thead>
				<tbody>
					<%
					...
					<tr>
						...
						<td><a href="view.jsp?b_cord=<%= list.get(i).getB_cord() %>">
