                ...
                <div class="carlist">
                    ...
                    <div class="main">
                        <ul class="car">
                        	<%
                        		...
                        		ArrayList<Car> list = carDAO.getSearch(request.getParameter("model_search"));
                        		if (list.size() == 0){
                    ...
                    <div class="pageBtn">
                    	<ul class="pageBtn_ul">
	                    	<% if(pageNumber != 1){ %>
	                    	<li>
	                    		<a class="pageBtn_move" href="CarsSearch.jsp?pageNumber=<%=pageNumber - 1 %>" >이전 페이지</a>
	                    	</li>
							<% } else {%>	
	                    	<li>
	                    	...
	                    	<% } %>
	                    	<li>
	                    		<a class="pageBtn_now" href="CarsSearch.jsp?pageNumber=<%=pageNumber %>"><%=pageNumber %></a>
	                    	</li>
	                    	<% if(carDAO.nextPage(pageNumber + 1)){ %>
	                    	<li>
	                    		<a class="pageBtn_move" href="CarsSearch.jsp?pageNumber=<%=pageNumber + 1 %>">다음 페이지</a>	
	                    	</li>
	                    	<% } else {%>
	                    	<li>
